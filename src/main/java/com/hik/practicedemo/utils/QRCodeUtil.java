...
/**
 * Created by wangJinChang on 2019/12/17 21:32
 * 二维码工具类
 */
public class QRCodeUtil {
    ...
    private static void insertImage(BufferedImage source, String imgPath, boolean needCompress) throws IOException {
        ...
        Graphics2D graph = source.createGraphics();         // 插入LOGO
    ...
    public static void encode(String content, String imgPath, String destPath, boolean needCompress) throws IOException, WriterException {
        ...
        // ImageIO.write(image, FORMAT_NAME, new File(destPath+"/"+file));  //设置随机文件名
    ...
    public static void encode(String content, String imgPath, OutputStream output, boolean needCompress) throws IOException, WriterException {
        BufferedImage image = QRCodeUtil.createImage(content, imgPath, needCompress);
